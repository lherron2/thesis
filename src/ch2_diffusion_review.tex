...
\end{equation}
where $\mathbf{B}_t$ is a Brownian motion. The linear drift in Eq. \ref{ch2:eq:drift} allows for simulation free evaluation of the SDE, since the conditional path distribution $p(\mathbf{x},t | \mathbf{x}_0,0)$ originating from any $\mathbf{x}_0 \equiv \mathbf{x}(t=0)$ has closed form \cite{score-based-generative,nonequilibrium-learning}.
...
\begin{figure}[hb]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/ch2_panel_gmm_modes.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/ch2_panel_asym.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/ch2_panel_gmm_si.jpg}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=1\textwidth]{figures/ch2_panel_aib9.jpg}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=.9\textwidth]{figures/ch2_panel_tuning.jpg}
