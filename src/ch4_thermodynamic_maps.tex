...
\section{Targeted Free Energy Perturbation}
\label{ch4:sec:TFEP}
...
\section{Leveraging Non-Equilibrium Thermodynamics}
\label{ch4:sec:FPE}
...
\section{Critical Behavior of the Ising Model}
\label{ch4:sec:ising}
...
\section{Exploring RNA Conformational Landscapes with Thermodynamic Map-accelerated Molecular Dynamics (TM-aMD)}
\label{ch4:sec:RNA}
...
The next chapter builds on this thermodynamic framework by embedding Thermodynamic Maps in a full \textit{ab initio} RNA structure-prediction pipeline, RNAnneal, where they serve as the central component for ranking candidate RNA structures.
