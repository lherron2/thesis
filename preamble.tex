...
\newcommand{\thesistitle}{Physics-inspired Generative Deep Learning with Applications to RNA structure prediction}
\newcommand{\thesistitlecaps}{PHYSICS-INSPIRED GENERATIVE DEEP LEARNING WITH APPLICATIONS TO RNA STRUCTURE PREDICTION}
...
\titleformat{\chapter}{\normalfont\large}{Chapter \thechapter:}{1em}{\bfseries}
\titleformat{name=\chapter,numberless}{\normalfont\large\filcenter}{}{0pt}{\bfseries}
...
\g@addto@macro\appendix{%
  \titleformat{\chapter}{\normalfont\large}{Appendix \thechapter:}{1em}{\bfseries}%
  \addtocontents{toc}{%
